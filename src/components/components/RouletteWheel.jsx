...
const data = [
  { option: '00', style: { backgroundColor: '#89c33b', textColor: 'white' } },
  { option: '0', style: { backgroundColor: '#89c33b', textColor: 'white' } },
...
const outerBorderColor = '#cdcfda';
const outerBorderWidth = 5;
const innerBorderColor = '#2c2f3a';
